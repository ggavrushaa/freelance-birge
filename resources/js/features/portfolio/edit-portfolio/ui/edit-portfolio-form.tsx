...
import z from 'zod';
import { editPortfolioSchema } from '../model/validation/edit-portfolio-schema';
...
interface EditPortfolioFormProps {
    defaultValues: z.infer<typeof editPortfolioSchema>;
    onSubmit: (data: z.infer<typeof editPortfolioSchema>) => void;
    onCancel: () => void;
}

export const EditPortfolioForm = (props: EditPortfolioFormProps) => {
    ...
    const {
        ...
        control,
        formState: { isValid },
    } = useForm<z.infer<typeof editPortfolioSchema>>({
    ...
    const photoFilePreview = photoFile.preview ?? defaultValues.image ?? '';

    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <FormImagePreview
                preview={photoFilePreview}
            ...
            <Controller
                ...
                render={({ field }) => (
                    ...
                    >
                        <SelectTrigger className="mb-3 bg-[#efeff4]">
            ...
            <Controller
                ...
                render={({ field }) => {
                    ...
                    return (
                        ...
                        >
                            <SelectTrigger className="mb-6 bg-[#efeff4]">
