    ...
    return (
        ...
        >
            <SwitchPrimitive.Thumb
                ...
                className={cn(
                    'pointer-events-none block size-3.5 rounded-full bg-background ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-1px)] data-[state=unchecked]:translate-x-[2px] dark:data-[state=checked]:bg-primary-foreground dark:data-[state=unchecked]:bg-[#fff]',
                )}
            />
        </SwitchPrimitive.Root>
    );
